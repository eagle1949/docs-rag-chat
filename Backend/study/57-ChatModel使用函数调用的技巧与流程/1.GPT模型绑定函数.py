...
class GaodeWeatherTool(BaseTool):
    ...
    def _run(self, *args: Any, **kwargs: Any) -> str:
        ...
        try:
            ...
            gaode_api_key = os.getenv("GAODE_API_KEY", "9fc0627ec0a40f131bd31f240982b374")
...
# 检查SERPER_API_KEY是否存在
serper_api_key = os.getenv("SERPER_API_KEY")
if not serper_api_key:
    print("警告: SERPER_API_KEY环境变量未设置，Google搜索功能将不可用")
    ...
    google_serper = GoogleSerperRun(
        ...
        api_wrapper=GoogleSerperAPIWrapper(serper_api_key=serper_api_key),
    )
tool_dict = {
    gaode_weather.name: gaode_weather,
}
if google_serper:
    tool_dict[google_serper.name] = google_serper
